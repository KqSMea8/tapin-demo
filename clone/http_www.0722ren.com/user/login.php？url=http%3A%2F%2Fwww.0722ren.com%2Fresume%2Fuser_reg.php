...
$(document).ready(function()
{
	...
	e.preventDefault();
				...
				else
		{
			...
			$.post("/plus/ajax_user.php", {"username": $("#username").val(),"password": $("#password").val(),"expire":expire,"url":"http://www.0722ren.com/resume/user_reg.php","postcaptcha":$("#postcaptcha").val(),"time": new Date().getTime(),"act":"do_login"},
...
<body>
	...
	<div id="login-box">
				<h1>会员登录</h1>
		<form action="http://www.0722ren.com/user/login.php?url=http%3A%2F%2Fwww.0722ren.com%2Fresume%2Fuser_reg.php" id="pcLogin">
