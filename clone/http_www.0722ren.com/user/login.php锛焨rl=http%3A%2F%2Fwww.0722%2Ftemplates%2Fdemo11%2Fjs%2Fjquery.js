...
$(document).ready(function()
{
	...
	e.preventDefault();
				...
				else
		{
			...
			$.post("/plus/ajax_user.php", {"username": $("#username").val(),"password": $("#password").val(),"expire":expire,"url":"http://www.0722/templates/demo11/js/jquery.js","postcaptcha":$("#postcaptcha").val(),"time": new Date().getTime(),"act":"do_login"},
...
<body>
	<!-- 头部 -->
		...
		<div class="container">
			<div class="logo-box f-left">
				<a href="/" class="logo f-left"><img src="/data/images/logo.png" alt="随州人才网" width="261" height="70" border="0"/></a>
	...
	<div id="login-box">
		...
		<form action="" id="pcLogin">
			...
			<div class="login-input-item clearfix">
				...
				<div class="login-ver f-left"><img src="/include/imagecaptcha.php?t=" id="getcode" align="absmiddle"  style="cursor:pointer;width: 100px;height: 38px;" title="看不请验证码？点击更换一张"  border="0" /></div>
			</div>
	...
	<div id="footer" style="background-color:#ffffff;">
		<div class="copy-right" style="background-color:#ffffff;color:#333333">
			...
			Copyright @ 2016 0722ren.com All Right Reserved   <script src='http://s14.cnzz.com/stat.php?id=893868&web_id=893868&online=2' language='JavaScript' charset='gb2312'></script><span style="DISPLAY: none"><script language="javascript" type="text/javascript" src="http://js.users.51.la/1891441.js"></script><script>var _hmt = _hmt || [];(function() {var hm = document.createElement("script");hm.src = "//hm.baidu.com/hm.js?d6c43a5b68a1b1eade9b230287ea1290";var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(hm, s);})();</script></span> <br />
			Powered by <a href="http://www.0722ren.com/" target="_blank" style="color:#333333">0722ren.com 随广传媒版权所有</a>
		</div>
	</div>
