...
<!-- @fragment_top Start--><meta charset="UTF-8">
...
<link rel="Shortcut Icon" href="../../../https_imgcache.qq.com/qzone/openapi/favi_con.ico%EF%BC%9Ft=20130219" type="image/x-icon">
<link rel="icon" href="../../../https_imgcache.qq.com/qzone/openapi/favi_con.ico%EF%BC%9Ft=20130219" type="image/x-icon">
<link href="../../../https_imgcache.qq.com/open/_connect/widget/pc/login/qlogin_v2.min.css%EF%BC%9Fmax_age=2592000&amp;v=20140818" rel="stylesheet">
...
<script src="../../../https_imgcache.qq.com/c/=/open/_connect/widget/pc/login/pt_adapt.js,qlogin_v2.js%EF%BC%9Fv=20140527" charset="UTF-8"></script><script>
    document.write('<script src="https://tajs.qq.com/stats?sId=52725868" charset="UTF-8"><\/script>');
</script><!--@fragment_bottom End --><script>
    // PC错误页曝光量
    Q.monitor(302300);
    // support论坛逻辑
    var feed_back_link = document.getElementById("feed_back_link_err");
    var dmRe = /http:\/\/([^/]*)\/?/i;
    window.crtDomain = 'http://www.0722ren.com' || (Q.getParameter && Q.getParameter("redirect_uri"));
    var errcode = '100010';
