...
$(document).ready(function()
{
	...
	e.preventDefault();
				...
				else
		{
			...
			$.post("/plus/ajax_user.php", {"username": $("#username").val(),"password": $("#password").val(),"expire":expire,"url":"http://www.0722/user/connect_qq_client.php","postcaptcha":$("#postcaptcha").val(),"time": new Date().getTime(),"act":"do_login"},
...
<body>
	...
	<div id="login-box">
				<h1>会员登录</h1>
		<form action="http://www.0722ren.com/user/login.php?url=http%3A%2F%2Fwww.0722%2Fuser%2Fconnect_qq_client.php" id="pcLogin">
