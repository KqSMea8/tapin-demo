...
function search_location(dir) {
	...
	var refre=$("input[name=refre]").val();
	var sort=$("input[name=sort]").val();
	var nature=$("input[name=nature]").val();
	var education=$("input[name=education]").val();
	var page=1;
	$.get(dir+"plus/ajax_search_location.php", {"act":listype,"key":key,"citycategory":citycategory,"category":category,"classtype":classtype,"start":start,"refre":refre,"sort":sort,"nature":nature,"education":education,"page":page},
