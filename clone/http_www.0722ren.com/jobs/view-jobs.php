...
当前位置：<a href="../index.html">首页</a> &gt;&gt; <a href="index.html">浏览过的职位</a>
</div>
	<div class="container">
		<div id="filterSearch">
			<div class="search-tab clearfix">
				...
				<a href="view-jobs.php" class="s-tab-item f-left active">浏览过的职位</a>
			</div>
			<!-- 职位列表 -->
