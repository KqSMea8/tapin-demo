...
<link href="../templates/demo11/css/link.css" rel="stylesheet" type="text/css">
...
function imgcaptcha(inputID,imgdiv)
{
	$(inputID).focus(function(){
		...
		if ($(imgdiv).html()=='')
		{
		$(imgdiv).append("<img src=\"/include/imagecaptcha.php?t=683297090\" id=\"getcode\" align=\"absmiddle\"  style=\"cursor:pointer; margin:3px;\" title=\"看不请验证码？点击更换一张\"  border=\"0\"/>");
		}
...
<script type="text/javascript">
    ...
    当前位置：<a href="../index.html">首页</a> &gt;&gt; 友情链接申请
  </div>
  <!-- 主体内容 -->
  <div class="container link_bk">
    ...
    <div class="left_area subscribe">
      ...
      <div class="company_list">
         <form action="http://www.0722ren.com/link/add_link.php?act=save" method="post">
        <div class="subscribe_box">
          <ul>
<li>
              <div class="w83" align="right">
<font color="red" style="margin-right:3px;">*</font>申请页面：</div>
              	<input name="alias" id="alias" type="hidden" value="QS_index"><div class="input_box">
    ...
    <div class="right_area">
      <div class="right_box">
        ...
        <div class="list sub_right">
          <p>有意与本站交换链接的同盟请注意：<br>
1、贵网站为人才相关网站；<br>
2、首页友情连接，要求pr&gt;=1、alexa &lt; 10000；其他页面连接根据具体页面而定（请具体咨询）。<br>
3、贵网站要在百度google都有记录收录，且网站访问速度不能太慢。</p>
        </div>
      </div>
    </div>
    <div class="clear"></div>
