...
<link href="../templates/demo11/css/jobfair.css" rel="stylesheet" type="text/css">
<script src="../templates/demo11/js/jquery.js" type="text/javascript"></script><script src="../../http_api.map.baidu.com/api.html%EF%BC%9Fv=1.2" type="text/javascript"></script><script src="../templates/demo11/js/dialog-min.js" type="text/javascript" language="javascript"></script><script src="../templates/demo11/js/dialog-min-common.js" type="text/javascript" language="javascript"></script><link href="../templates/demo11/css/ui-dialog.css" rel="stylesheet" type="text/css">
<script src="../templates/demo11/js/tc.all.js" type="text/javascript" language="javascript"></script><script type="text/javascript">
$(document).ready(function(){
	//地图定位
	// jobfairmap_dialog('.check_full_map',"/plus/ajax_com_map.php?act=company_map");
	$(".check_full_map").die().live('click', function() {
		var map_x = $(this).attr("map_x"),
	    	...
	    	url_="/plus/ajax_com_map.php?act=company_map&map_x="+map_x+"&map_y="+map_y+"&map_zoom="+map_zoom+"&companyname="+encodeURIComponent(title) +"&address="+encodeURIComponent(address)+"&timestamp"+ new Date().getTime();
	    var fullMapHtm = '<div class="ui-popup ui-popup-modal ui-popup-show ui-popup-focus" id="altContentBox" style="width:700px;"><div i="dialog" class="ui-dialog"><div class="ui-dialog-arrow-a"><div class="ui-dialog-arrow-b"><table class="ui-dialog-grid"><tr><td i="header" class="ui-dialog-header"><button i="close" class="ui-dialog-close">&#215;<div i="title" class="ui-dialog-title">地图定位<tr><td i="body" class="ui-dialog-body"><div i="content" class="ui-dialog-content" style="width:660px;" id="full_map_box"><div i="content" class="ui-dialog-content" id="content:1437014603087" style="width: 400px;">地图正在加载中...';
	...
	//在线预订
	boothjobfair_dialog('.booth','/plus/ajax_booth_jobfair.php');
});
$(function(){
...
<li>
                            ...
                            <li>
                                ...
                                <a href="jobfair-list.php" target="_blank">招聘会</a>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		当前位置：<a href="../index.html">首页</a>&gt;招聘会
	</div>
	<!-- 主体内容 -->
...
<!-- 预定中 --><!-- 预定中 End--><!-- 未开始 --><!-- 未开始 End--><!-- 已结束 --><tr>
<td class="list" style="width:250px;">      <a target="_blank" href="../jobs/3.html" title="2018年广水市新春企业专场招聘会">2018年广水市新春企业专场招聘会</a>
</td>
					<td align="center" class="list">2018-02-23 至 2018-02-25</td>
					<td align="center" class="list" style="width:450px;">广水市应山东岳广场<a class="check_full_map" map_x="113.840586" map_y="31.623019" map_zoom="18" title_="2018年广水市新春企业专场招聘会" address="广水市应山东岳广场" href="javascript:;"><img src="../templates/demo11/images/jobfairmapbg.png"></a>
</td>
					<td align="center" class="list">预定结束    </td>
				</tr>
<tr>
<td class="list" style="width:250px;">      <a target="_blank" href="../jobs/2.html" title="2018年随州市“春风送温暖”就业扶贫专场招聘会">2018年随州市“春风送温暖”就业扶...</a>
</td>
					<td align="center" class="list">2018-02-24 至 2018-02-24</td>
					<td align="center" class="list" style="width:450px;">随县人社局广场<a class="check_full_map" map_x="113.309427" map_y="31.855771" map_zoom="18" title_="2018年随州市“春风送温暖”就业扶贫专场招聘会" address="随县人社局广场" href="javascript:;"><img src="../templates/demo11/images/jobfairmapbg.png"></a>
</td>
					<td align="center" class="list">预定结束    </td>
				</tr>
<tr>
<td class="list" style="width:250px;">      <a target="_blank" href="../jobs/1.html" title="2018年随州市“春风行动”启动仪式暨专场招聘会">2018年随州市“春风行动”启动仪式...</a>
</td>
					<td align="center" class="list">2018-02-23 至 2018-02-23</td>
					<td align="center" class="list" style="width:450px;">随州市劳动就业管理局<a class="check_full_map" map_x="113.364035" map_y="31.734655" map_zoom="18" title_="2018年随州市“春风行动”启动仪式暨专场招聘会" address="随州市劳动就业管理局" href="javascript:;"><img src="../templates/demo11/images/jobfairmapbg.png"></a>
</td>
					<td align="center" class="list">预定结束    </td>
				</tr>
<!-- 已结束 End-->
...
<li class="f-left"><a target="_blank" href="../user/company/company_jobs.php%EF%BC%9Fact=addjobs">发布职位</a></li>
					...
					<li class="f-left"><a target="_blank" href="jobfair-list.php">现场招聘会</a></li>
				</ul>
</div>
		</div>
