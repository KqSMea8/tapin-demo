...
<li class="f-left"><a href="index.php" target="_self" class="nav-item  active">首  页</a></li>
...
<script src="../templates/tpl_shop/default/js/dialog-min.js"></script><script>
	...
	//无登录情况 弹框登录
		...
		<div class="fourthree-right">
			...
			<a class="shop-asd"><img src="../templates/tpl_shop/default/images/shop-asd1.jpg" width="250" height="150" border="0"></a>
			<div class="your-like">
