	...
	<div class="header-logo-nav">
		<div class="container clearfix containernp">
			...
			<div class="school-nav f-right">
			    			        ...
			    			        <a href="train-lecturer-list.php" target="_self" class="s-nav-item f-left active">推荐讲师</a>
			    			</div>
		</div>
	</div>
</div>
...
<div class="cla"></div>
			...
			<div class="t-search-box f-left t-search-box-s">
				<div class="type-input-box f-left" id="hidden_input_box">
					<div class="key">请输入讲师姓名</div>
					<input class="s" type="text" name="key" id="key" value="" style="display:none;"><input name="citycategory" id="citycategory" type="hidden" value=""><input name="education" id="education" type="hidden" value=""><input name="sort" id="sort" type="hidden" value=""><input type="hidden" name="page" id="page" value="">
</div>
			</div>
		...
		<div class="fliter-wrap">
			<div class="filter-list-wrap clearfix">
				...
				<div class="fl-content r-choice f-left">
															<div class="fl-content-li fl-content-li-s" type="education" code="65">初中</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="66">高中</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="67">中技</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="68">中专</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="69">大专</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="70">本科</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="71">硕士</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="72">博士</div>
										<div class="fl-content-li fl-content-li-s" type="education" code="73">博后</div>
									</div>
			</div>
		</div>
...
<div class="recommend_lecturer_list">
	<div class="h h-nb">
		...
		<div class="s">
			<a href="train-lecturer-list.php%EF%BC%9Feducation=&amp;citycategory=&amp;inforow=&amp;sort=rtime" class="select">更新时间</a>
		    <a href="train-lecturer-list.php%EF%BC%9Feducation=&amp;citycategory=&amp;inforow=&amp;sort=hot">热度</a>
		</div>
