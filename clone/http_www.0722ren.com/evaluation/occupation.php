...
$(document).ready(function(){
	// 点击测评
	is_answer_dialog(".start-review");
});
</script>
</head>
<body>
	<div id="reviews-header" class="">
...
<span>服务热线：0722-3588122</span> | <a href="../index.html">返回人才网</a>
		...
		<div class="header-logo-nav">
			<div class="container clearfix">
				...
				<div class="reviews-nav f-right">
															<a href="index.php" target="_self" class="s-nav-item f-left ">测评首页</a>
										<a href="selfcognition.php" target="_self" class="s-nav-item f-left ">自我认知测评</a>
										<a href="occupation.php" target="_self" class="s-nav-item f-left  active">职业倾向测评</a>
	...
	</div>	<div class="review-main container">
		<div class="review-wrap">
			<div class="g-top-box">
				<h1><span>职业倾向测评</span></h1>
				<div class="main-type-box clearfix">
					<div class="type-box f-left"><img src="../templates/tpl_evaluation/default/images/review-type1.jpg" alt="" width="130"></div>
					<div class="type-content">
						<div class="type-info">适用人群：初入职场、应届毕业生 <br>已有0人参与</div>
			...
			<div class="g-main-box">
								<div class="no-data">
					<i class="no-data-icon"></i><span>哎，还没有相关测评试卷呢！</span>
				</div>
							</div>
		</div>
	</div>
...
</script><script src="../templates/tpl_evaluation/default/js/jquery.js"></script><script>
		$(function() {
			$('.sub-review-item:last').css({'border-bottom': 0});
		});
